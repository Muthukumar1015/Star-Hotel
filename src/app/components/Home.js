...
const slides = [
  { src: "/images/bannerThumb1_1.png", alt: "Spicy Fried Chicken", text: "SPICY FRIED CHICKEN" },
  { src: "/images/bannerThumb1_2.png", alt: "Chicago Deep Pizza King", text: "CHICAGO DEEP PIZZA KING" },
  { src: "/images/bannerThumb1_3.png", alt: "Chicago Deep Burger King", text: "CHICAGO DEEP BURGER KING" }
];
    ...
    <>
      ...
      <div className={styles.heroContainer}>
        ...
        {slides.map((slide, index) => (
          <div
            key={index}
            className={`${styles.slide} ${index === currentSlide ? (direction === "right" ? styles.enterRight : styles.enterLeft) : styles.hidden}`}
          >
            {/* Text Section */}
      ...
      <div className={styles.foodSlider}>
        {foodItems.map((food, index) => (
          <div key={index} className={styles.foodItem}>
            ...
            />
            <p className={`${styles.foodText} ${textVisible ? styles.visible : styles.hidden}`}>
              {food.text}
            </p>
          </div>
        ))}
        ...
        {offerCards.map((offer, index) => (
          <div key={index} className={styles.offerCard}>
            ...
            <div className={styles.offerText}>
              ...
              <button className={styles.orderButton}>{offer.buttonText}</button>
            </div>
          </div>
        ))}
      </div>
